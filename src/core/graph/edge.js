  ...
  constructor(name: string) {
    ...
    switch (name) {
      case ('_e_accept_trade'):
        ...
        this.check = (game) => {
          throw new CatonlineError('not implemented'); // f.tradeAccepted;
        };
        this.arguments = '';
      ...
      case ('_e_accept_trade_other'):
        ...
        this.check = (game) => {
          throw new CatonlineError('not implemented'); // f.canAcceptTrade;
        };
        this.arguments = '';
        this.execute = (game, participant, argv) => {
      ...
      case ('_e_discard_move_robber'):
        ...
        this.check = (game) => {
          throw new CatonlineError('not implemented'); // f.isCurrentPlayer && f.isRollSeven && !f.waitForDiscard;
        };
        this.arguments = 'hex';
        this.execute = (game, participant, argv) => {
      ...
      case ('_e_roll_discard'):
        ...
        this.check = (game) => {
          throw new CatonlineError('not implemented'); // f.discard > 0;
        };
        this.arguments = 'trade';
        this.execute = (game, participant, argv) => {
      ...
      case ('_e_take_turn'):
        this.target = '_v_root';
        this.check = (game) => {
          throw new CatonlineError('not implemented'); // f.isCurrentPlayer;
        };
        this.arguments = '';
        this.execute = (game, participant, argv) => {
          throw new CatonlineError('not implemented');
