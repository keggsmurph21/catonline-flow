...
var EdgeResultError = exports.EdgeResultError = function (_CatonlineError4) {
  _inherits(EdgeResultError, _CatonlineError4);

  function EdgeResultError(message) {
    _classCallCheck(this, EdgeResultError);

    var _this5 = _possibleConstructorReturn(this, (EdgeResultError.__proto__ || Object.getPrototypeOf(EdgeResultError)).call(this, message));

    _this5.name = 'EdgeResultError';
    return _this5;
  }

  return EdgeResultError;
}(CatonlineError);