...
var GAME_PARAM_TILESTYLE_DEFAULT = exports.GAME_PARAM_TILESTYLE_DEFAULT = GAME_PARAM_TILESTYLE_OPTIONS[0];
...
var DEVCARD_NAMES_MAP = exports.DEVCARD_NAMES_MAP = {
...
var BANK_TRADE_RATES = exports.BANK_TRADE_RATES = {
  wheat: 4,
  sheep: 4,
  brick: 4,
  wood: 4,
...
var EDGE_NAMES = exports.EDGE_NAMES = ["_e_accept_trade", "_e_accept_trade_other", "_e_after_discard_other", "_e_after_trade_other", "_e_build_city", "_e_build_road", "_e_build_settlement", "_e_buy_dc", "_e_cancel_trade", "_e_decline_trade", "_e_discard_move_robber", "_e_end_game", "_e_end_init", "_e_end_turn", "_e_fail_trade", "_e_init_build_road", "_e_init_collect", "_e_init_settle", "_e_init2_build_road", "_e_no_steal_robber", "_e_offer_trade", "_e_play_knight", "_e_play_monopoly", "_e_play_rb", "_e_play_vp", "_e_play_yop", "_e_roll", "_e_roll_exact", "_e_roll_collect", "_e_roll_discard", "_e_roll_discard_other", "_e_roll_move_robber", "_e_steal_robber", "_e_take_turn", "_e_to_root", "_e_trade_bank"];

var VERTEX_NAMES = exports.VERTEX_NAMES = ['_v_accept_trade', '_v_accept_trade_other', '_v_buy_dc', '_v_collect', '_v_discard', '_v_discard_other', '_v_end_game', '_v_end_turn', '_v_fortify', '_v_init_collect', '_v_move_robber', '_v_offer_trade', '_v_pave', '_v_play_knight', '_v_play_monopoly', '_v_play_rb', '_v_play_vp', '_v_play_yop', '_v_roll', '_v_root', '_v_settle', '_v_steal', '_v_trade_with_bank'];

var DICE_DOTS_MAP = exports.DICE_DOTS_MAP = {
  '-1': 0,
  '0': 0,
  '2': 1,
  '3': 2,
