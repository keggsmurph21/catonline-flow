  ...
  switch (name) {
    ...
    case '_e_discard_move_robber':
      ...
      this.validateArgs = function (game, args) {
        ...
        var hex = game.board.hexes[args.hex];

        if (!hex) throw new _utils.EdgeArgumentError('cannot get Hex at "' + args.hex + '"');
    ...
    case '_e_roll':
      ...
      this.validateArgs = function (game, args) {
        ...
        if (args.num == undefined) return undefined;
        ...
        if (isNaN(num)) throw new _utils.EdgeArgumentError('cannot roll number "' + args.num + '"');
