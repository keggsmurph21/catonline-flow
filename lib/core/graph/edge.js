    ...
    switch (name) {
      ...
      case '_e_roll':
        ...
        this.execute = function (game, participant, args) {
          ...
          var ret = game.roll();
          return _edgeResult.EdgeResult.fromString('diceroll', String(ret), game);
        };
        this.isPriority = false;
        this.label = '';
        break;
      ...
      case '_e_roll_exact':
        this.target = '_v_roll';
        this.check = function (game, participant) {
          return !game.hasRolled && !game.isFirstTurn() && !game.isSecondTurn(); // DEBUG_MODE
        };
