  ...
  switch (name) {
    case '_e_accept_trade':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.tradeAccepted;
      };
      this.arguments = '';
    ...
    case '_e_accept_trade_other':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.canAcceptTrade;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_after_discard_other':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // true;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_build_city':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.hasRolled && f.canBuild.city;
      };
    ...
    case '_e_build_road':
      this.target = '_v_pave';
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.hasRolled && f.canBuild.road;
      };
      this.arguments = 'road';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_build_settlement':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.hasRolled && f.canBuild.settlement;
      };
      this.arguments = 'settlement';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_buy_dc':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.hasRolled && f.canBuy.dc;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_discard_move_robber':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.isCurrentPlayer && f.isRollSeven && !f.waitForDiscard;
      };
      this.arguments = 'hex';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_end_game':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.isGameOver;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_end_init':
      this.target = '_v_end_turn';
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.isFirstTurn || f.isSecondTurn;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_end_turn':
      this.target = '_v_end_turn';
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.hasRolled;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
        throw new _utils.CatonlineError('not implemented'); // iterateTurn(m,g,p);
    ...
    case '_e_fail_trade':
      this.target = '_v_root';
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // !f.waitForTrade;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_init_build_road':
      this.target = '_v_pave';
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.isFirstTurn;
      };
      this.arguments = 'road';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_init_collect':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.isSecondTurn;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_no_steal_robber':
      this.target = '_v_root';
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // !f.canSteal;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
        throw new _utils.CatonlineError('not implemented');
    ...
    case '_e_offer_trade':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // !f.isFirstTurn && !f.isSecondTurn && f.hasRolled && f.canTrade;
      };
    ...
    case '_e_play_knight':
      this.target = '_v_move_robber';
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.canPlayDC.knight;
      };
      this.arguments = 'hex';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_play_monopoly':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.canPlayDC.monopoly;
      };
    ...
    case '_e_play_rb':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.canPlayDC.rb;
      };
    ...
    case '_e_play_vp':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.canPlayDC.vp;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_play_yop':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.canPlayDC.yop;
      };
    ...
    case '_e_roll':
      this.target = '_v_roll';
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // !f.hasRolled && !f.isFirstTurn && !f.isSecondTurn;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_roll_collect':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // !f.isRollSeven;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_roll_discard':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.discard > 0;
      };
      this.arguments = 'trade';
      this.execute = function (game, participant, argv) {
    ...
    case '_e_take_turn':
      this.target = '_v_root';
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // f.isCurrentPlayer;
      };
      this.arguments = '';
      this.execute = function (game, participant, argv) {
        throw new _utils.CatonlineError('not implemented');
    ...
    case '_e_trade_bank':
      ...
      this.check = function (game) {
        throw new _utils.CatonlineError('not implemented'); // !f.isFirstTurn && !f.isSecondTurn && f.hasRolled && f.canTradeBank;
      };
      this.arguments = 'trade';
      this.execute = function (game, participant, argv) {
