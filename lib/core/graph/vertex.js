...
var Vertex = exports.Vertex = function Vertex(name) {
  ...
  switch (name) {
    ...
    case '_v_root':
      this.edges = ['_e_build_city', '_e_build_road', '_e_build_settlement', '_e_buy_dc', '_e_end_turn', '_e_init_settle', '_e_offer_trade', '_e_play_knight', '_e_play_monopoly', '_e_play_rb', '_e_play_vp', '_e_play_yop', '_e_roll', '_e_roll_exact', '_e_trade_bank'];
      break;
