...
var Participant = exports.Participant = function () {
  ...
  _createClass(Participant, [{
    ...
    value: function canAcceptCurrentTrade() {
      ...
      if (trade.with.participants.indexOf(this) === -1) return false;
    ...
    key: '_shouldKeepControl',
    value: function _shouldKeepControl() {
    ...
    value: function _do(name, args) {
      ...
      var ret = this._do(name, args);

      while (this._shouldKeepControl()) {

        var edgeName = this.getEdges()[0].name;
        this._do(edgeName);
      }
