...
var Hand = exports.Hand = function () {
  function Hand(scenario) {
    ...
    this.unplayedDCs = {};
    this.unplayableDCs = {};
    _underscore2.default.each(scenario.devCards, function (count, name) {

      _this.playedDCs[name] = 0;
      _this.unplayedDCs[name] = 0;
      _this.unplayableDCs[name] = 0;
    });

    this.resources = {};
    _underscore2.default.each(scenario.resources, function (count, name) {

      _this.resources[name] = 0;
    });
  }
